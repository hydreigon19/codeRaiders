...
public class AIFirstLevel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CheckSpawn = false;
        found = false;
        load1 = GameObject.FindGameObjectWithTag("loader");
    ...
    void Update()
    {
        ...
        if (Vector2.Distance(transform.position, target.position) > stoppingDistance && follow==true)
        {
